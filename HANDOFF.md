...
## Ссылки
- Репозиторий: https://github.com/sashik08/openclaw-stack (публичный, ветка `main`)
- Релиз: https://github.com/sashik08/openclaw-stack/releases/tag/v1.0.0
- Установка одной командой (для пользователя):
